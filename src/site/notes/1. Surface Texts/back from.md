...
This appears to be a point upon which many [[1. Surface Texts/devils can dance\|devils can dance]], which is clarified, for my purposes, only by way of a [[1. Surface Texts/clear\|clear]] view on power differentials. Here we could see for example the difference between a [[1. Surface Texts/claim\|claim]] which can be stated with authority to one's own interiority, land and heritage, versus the use of a seemingly very similar claim utilised in the hardening of narratives into exclusionary coherence in furtherance of the sovereign power of transpersonal entities, such as states or corporations. So far, all I can really say is that I'm interested to move along that tart line. It is a line that negotiates with discomfort, in that as it deals with narrative, it deals with the irretrievability of the unity of the past. What to do in the face of ultimate discombobulation, consumption and reconstitution? Perhaps these are not questions that I can answer, but only open up a little, from the perspective through which I entered into them: the question of Tikkun.
...
Re- acknowledges a turning back, but without [[3. Concepts/implication\|implication]]. Implication: the fact that time passed as we moved about our orbit, that that orbit is a spiral form hurtling through space. We cannot re-turn to what was left behind, but only to a new iteration of it, to which we are re-newedly, and in [[2. Main Theoretical Pillars/Theory Notes/wolfson-repetition-difference\|grown]] form, attached. 
